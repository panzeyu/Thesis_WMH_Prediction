...
# This is an official script from TensorFlow for batch-processing images, please find the link below for running instruction.
# https://github.com/tensorflow/models/tree/master/research/real_nvp
# Some changes were made for solving compatibility issue.
